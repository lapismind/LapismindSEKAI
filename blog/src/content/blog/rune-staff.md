...
v1.1 交完，我把法阵也丢回去让它重做。这回它给的是两副面孔：

![斧形态：法阵内面展开成两把新月刃](../../assets/posts/rune-staff-v12-axe.jpg)

剑盾形态举盾防御，是一整面星钟法阵；切到斧形态，法阵内面直接变成两把新月刃，外圈和罗马数字照旧留着。

中间它自己推了几轮：蓝色轴心单独配了宝石材质，时钟两半掰成月牙，按形态切换，最后把蓝膜的质感又过了一遍。

**每一轮，大约六分半。**

我全程就三个动作：进游戏、看一眼、回一句"可以"或者"再推一下"。

## 一些限制

- 发布包不分发「理科魔女」那套皮肤，也不依赖它，截图里是作者 Fruit milk 的 mod
- 模型预览和实机图都在作品页，下载在 GitHub
