...
const SECTIONS = [
  ...
  {
    icon: '🤖',
    title: 'AI 主持（大肥鱼）· beta',
    items: [
      '暂时关闭：AI 判定提问的准确率和 token 成本都还没到，所以现在只能玩真人主持。',
      '以后会由 AI 扮演主持人「大肥鱼」自动判定每个提问，条件合适了再开放。',
    ],
  },
  {
    icon: '🕵️',
  ...
  },
  {
    ...
    items: [
      ...
      '复盘：所有人可写共享笔记。「AI 复盘」提示随 AI 主持一起暂时关闭。',
    ],
  },
  {
    icon: '⏳',
