/**
 * game/avatars.js
 * 默认头像 —— 26 张（avatars/1.png ~ 26.png）。
 * avatarId 为 '1'~'26'，'0' 或缺失时用首字占位。
 */
...
const AVATAR_URLS = [
  ...
  avatar10, avatar11, avatar12, avatar13, avatar14, avatar15, avatar16, avatar17,
  avatar18, avatar19, avatar20, avatar21, avatar22, avatar23, avatar24, avatar25,
  avatar26,
]

export const AVATAR_COUNT = AVATAR_URLS.length

/** 按 avatarId 拿头像 URL；非法则返回 null（前端用首字占位） */
